export const pageContent = {
	fr: {
		...
		story: {
			sectionTitle: "Subventions pour PME",
			...
			testimonial:
				"« Nous recommandons grandement Steven pour sa flexibilité, son engagement, son intégrité et sa rigueur dans la gestion des délais. Il a joué un rôle significatif dans la planification de notre projet et la rédaction de documents complexes. »",
			testimonialAuthor: "Diane Andicha Picard",
			testimonialRole: "Vice-présidente – Rendez-vous des artisans et artistes de Wendake"
		},
		values: {
	...
	en: {
		...
		story: {
			...
			testimonial:
				'"We highly recommend Steven for his flexibility, commitment, integrity, and rigor in managing deadlines. He played a key role in planning our project and writing complex documents."',
			testimonialAuthor: "Diane Andicha Picard",
			testimonialRole: "Vice-President - Rendez-vous des artisans et artistes de Wendake"
		},
		values: {
